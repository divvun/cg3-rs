    ...
    fn rr_add_map(
        ...
        if childset1 != 0 {
            ...
            let spot_hashes: Vec<u32> = spot_tags
                .iter()
                .map(|t| self.grammar.single_tags_list.get(t.0).hash)
                .collect();
